    ...
    stages {
        ...
        stage('Deploy Frontend to Tomcat') {
            steps {
                ...
                xcopy /E /I /Y Jenkins-curd\\dist\\* "C:\\Program Files\\Apache Software Foundation\\Tomcat 10.1\\webapps\\reactpersonal"
                '''
            }
        }
        ...
        stage('Deploy Backend to Tomcat') {
            steps {
                ...
                copy "Jenkins-Personal-CRUD\\target\\*.war" "C:\\Program Files\\Apache Software Foundation\\Tomcat 10.1\\webapps\\"
                '''
            }
        }
